...
import (
	...
	http2 "gist.github.com/vvakame/7a08b7f517b012cca09f82ec9ab4d1fd/gateway/http"
)
...
func startServer() {
	...
	datasourceWatcher := NewDatasourcePoller(httpClient, DatasourcePollerConfig{
		Services: []ServiceConfig{
			{Name: "base", URL: "http://localhost:4001/query"},
			{Name: "products", URL: "http://localhost:4002/query", WS: "ws://localhost:4002/query"},
			{Name: "history", URL: "http://localhost:4003/query"},
		},
